...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#name-tf'), $('#email-tf'), $('#user-tf'), $('#nickname-tf'), $('#pass-tf')];
	this.controlGroups = [$('#name-cg'), $('#email-cg'), $('#user-cg'), $('#nickname-cg'), $('#pass-cg')];
...
AccountValidator.prototype.validateForm = function() {
	...
	if (this.validateName(this.formFields[3].val()) === false) {
		...
		e.push('Please choose a nickname');
	}
